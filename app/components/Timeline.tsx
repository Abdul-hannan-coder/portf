        ...
        {timeline.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              className="relative flex items-start pl-14 sm:pl-16 mb-8 sm:mb-12 last:mb-0"
            >
              <div className="flex-shrink-0 w-9 sm:w-10 text-center relative">
                ...
                <motion.div
                  ...
                  whileHover={shouldReduceMotion ? undefined : { scale: 1.2, rotate: 360 }}
                  className={`flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full ring-2 sm:ring-4 ${
                    item.iconColor === "teal"
